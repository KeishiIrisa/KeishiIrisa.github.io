...
const translations = {
    ja: {
        ...
        'hero.name': '入佐啓士',
        'hero.title': '化学生命工学科学生',
        'hero.subtitle': '東京大学工学部 3年',
        'hero.cta': '詳しく見る',
        'about.title': 'について',
        'about.description': '東京大学工学部化学生命工学科で学ぶ3年生です。AI技術とWebエンジニアリングに情熱を注いでおり、これまでに複数のスタートアップや大手企業でのインターンシップを通じて実践的な経験を積んできました。',
        'projects.title': 'プロジェクト',
        'projects.project1.title': 'PDF Quiz Maker',
        'projects.project1.description': 'PDF教科書から質問、回答、説明を自動生成するAI駆動の学習ツール',
        'projects.project2.title': 'PR Times Hackathon',
        ...
        'experience.kotonoha.role': '共同創業者',
    ...
    en: {
        ...
        'about.description': "I'm a 3rd year Chemical and Biological Engineering student at The University of Tokyo. I'm passionate about AI technology and web engineering, having gained practical experience through internships at multiple startups and major companies.",
        ...
        'experience.emuni.description': 'Development of generative AI chat app for educational institutions (160,000 users)',
        'experience.cookpad.period': 'February 2025 - March 2025',
        'experience.cookpad.role': 'Search Engineer Intern',
        'experience.cookpad.description': 'Improved inappropriate query detection rate by 10% through search system enhancement',
        'experience.line.period': 'August 2024',
        'experience.line.role': 'Software Engineer Intern',
        'experience.line.description': 'Developed new features for advertising management tools and practiced Scrum development',
        'experience.kotonoha.period': 'July 2023 - April 2024',
        'experience.kotonoha.role': 'Co-founder',
        'experience.kotonoha.description': 'English learning app development • 1000+ downloads • 100 paid users acquired',
